...
<div class="container">
  ...
  <div class="card alt">
    <div class="toggle"> </div><div style="float:right;margin-right: -185%;margin-top: -70%; color:#1860d0;"><h3>&#9668 Click Here for Temprory Users</h3></div>
    <h1 class="title">Temprory User Login
      <div class="close"></div>
    </h1>
