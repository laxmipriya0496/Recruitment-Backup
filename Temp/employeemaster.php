	  ...
	  <div class="content-wrapper1">
		...
		<div class="row" style="margin-right:10%; width:112%; font-family:'Times New Roman', Times, serif">
            <div class="col-xs-3" style="padding-right:5px;">
			 <?php			
				$item_row=mssql_query("select * from temp_employee_master where user_id='$user' order by temp_employee_id desc");		
				$s1=1;
			 ?>
							...
							<div id="attrib-advanced" class="tab-pane active">
								<div style="position:relative; color:blue; float:left; line-height: 80px;">
					 			...
					 			<div style="text-transform: uppercase;font-size: 16px;padding-top: 1px;color: #000;line-height: 18px; font-weight:bold;float:right; position:relative;" >
									...
									<?php 
										echo $item_res['temp_employee_id'];
									?>
								</div><br>
								<div class="emp_name">
		...
		<?php  
		$item1=mssql_fetch_array(mssql_query("select top 1 * from temp_employee_master where user_id='$user' order by temp_employee_id desc"));
		if($id=="")
		{
			$id=$item1['id'];
		}
		...
		<div class="ravi">
			 ...
			 <div id="getemp">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title" style="font-family:Times New Roman;font-weight:bold;">Register</h3>
	  					<div id="xx">
