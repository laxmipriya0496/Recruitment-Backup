        ...
        <section class="content">
		  <div class="row">
			...
			<div class="box box-primary">
			 ...
			 $cus=mssql_fetch_array(mssql_query("select * from temp_user_master where user_id='$user'"));
			 $tot=$cus['nos'];
			 $entered=$cus['entered_nos'];
			 $availble=$tot-$entered;
			 ?>
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li ><a href="employeemaster.php?menu_id=<?php ////echo $menu_id;?>&sub_menu=<?php ////echo $submenu_id;?>"><i class="fa fa-file-text-o"></i>Employee List<span class="label label-primary pull-right"><?php echo $entered;?></span></a></li>
