	...
	?>  
	 ...
	 <div class="content-wrapper1">
        <!-- Main content --><section class="content-header">
         <h3><?php echo "Department : <b style='color:blue;'>$dep</b> " ;  ?></h3>
          <ol class="breadcrumb">
            <li><a href="../menu/index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="../Master/department.php"><i class="fa fa-dashboard"></i> Back</a></li>
          </ol>
        </section>
...
<?php
$s=1;
$cus=mssql_query("select * from employee_master where Department='$dep'");
