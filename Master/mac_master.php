				 ...
				 <form role="form" name="area"  method="post">
                  <div class="box-body">
                   <table class="table table-hover" style="font-family:'Times New Roman', Times, serif">
						<tr>
							<td>Mac Address</td>
							<td><input type="text" class="form-control" name="mac_address" id="mac_address" required></td>
						</tr>
						<tr>
							<td>IP Address</td>
							<td><input type="text" class="form-control" name="ip_address" id="ip_address" required></td>
						</tr>
					</table>					   
					  </div><!-- /.box-body -->
