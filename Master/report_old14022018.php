...
<div class="wrapper" style=" width: 98%; margin:0 auto;">
	...
	?>
	&nbsp;<input type="checkbox" name="Branch_of_Education" id="Branch_of_Education">&emsp;Branch_of_Education<br>
	...
	&nbsp;<input type="checkbox" name="Graduation" id="Graduation">&emsp;Graduation<br>
		...
		?>
		<th data-options="field:'Branch_of_Education',width:100"  sortable="true">BRANCH</th>
		<!--<th data-options="field:'type_of_education',width:100" sortable="true">TYPE</th>-->
		<th data-options="field:'University',width:100" sortable="true">UNIVERSITY</th>
		<th data-options="field:'Graduation',width:100" sortable="true">GRADUATION</th>
...
$u1=mssql_query("select *,m.id as did from employee_master m join employee_details d on m.employee_id=d.emp_id
 where m.Department in('$dep') order by Graduation desc");
$r=1;
$s=0;
...
$dataPoints1.=']';
//echo $dataPoints1."<br><br><br><br><br><br><br><br>";
/* 
