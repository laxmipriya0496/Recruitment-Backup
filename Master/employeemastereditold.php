			...
			<div class="box box-primary">
			 ...
			 <div class="col-md-9">
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="box-body">
                   <table class="table table-hover" style="font-family:'Times New Roman', Times, serif">
						...
						<tr>
							<td>Employee ID</td>
							<td><input type="text" name="emp_id" id="emp_id" class="form-control" value="<?php echo $eid=$item1['employee_id']; ?>"  ></td>
							<td>Employee Name</td>
				...
				<?php
				$state=mssql_query("select id,name from state_master where status='1' and name!='$st' order by name ");
...
<input type="hidden" name="edid[]" id="edid_<?php echo $s++; ?>" class="form-control" value="<?php echo $empde1['id']; ?>">
</tr>
...
$old_det=mssql_fetch_array(mssql_query("select * from employee_master where id='$id'"));
	...
	$old=array($old_emp_id,$old_Name,$old_Department,$old_Pan_Number,$old_Phone_Number,$old_email,$old_Religion,$old_Gender,$old_State_of_Origin,$old_Blood_Group,$old_Aadhar_Number);
	
	$new=array($emp_id,$Name,$Department,$Pan_Number,$Phone_Number,$email,$Religion,$Gender,$State_of_Origin,$Blood_Group,$Aadhar_Number);
	
	$field=array("employee_id","Name","Department","Pan_Number","Phone_Number","email","Religion","Gender","State_of_Origin","Blood_Group","Aadhar_Number");
	...
	$n=mssql_query("update employee_master  set Name='$Name',employee_id='$emp_id',Department='$Department',Pan_Number='$Pan_Number',Phone_Number='$Phone_Number',Gender='$Gender',Religion='$Religion',Aadhar='$Aadhar_Number',State_of_Origin='$State_of_Origin',Blood_Group='$Blood_Group',modified_by='$username',modified_on='$date' where id='$id'");
