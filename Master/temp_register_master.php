		 ...
		 <form role="form" name="area"  method="post">
                  <div class="box-body">
                   <table class="table table-hover" style="font-family:'Times New Roman', Times, serif">
						...
						<tr>
							<td>From Date</td>
							<td><input type="text" class="add-on form-control" id="from_date" name="from_date" placeholder="From Date" value=""required></td>
						</tr>
						<tr>
							<td>To Date</td>
							<td><input type="text" class="add-on form-control" id="to_date" name="to_date" placeholder="To Date" value=""required></td>
						</tr>
						<tr>
							<td>Total Numbers</td>
							<td><input type="number" class="form-control" name="number" id="number" required></td>
						</tr>
					</table>					   
					  </div><!-- /.box-body -->
...
{  
	...
	$n=mssql_query("insert into temp_user_master (full_name,user_name,password,email_id,mobile_no,status,from_date,to_date,nos,entered_nos,created_by,created_on) values 
	('$full_name','$user_name','$password','$e_mail','$mobile_no','0','$from_date','$to_date','$number','0','$user','$date')");	
