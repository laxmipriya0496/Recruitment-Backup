...
<body class="skin-blue fixed sidebar-mini">
	...
	?>  
	  ...
	  <div class="content-wrapper1">
		...
		<div class="row" style="margin-right:10%; width:112%; font-family:'Times New Roman', Times, serif">
            <div class="col-xs-3" style="padding-right:5px;">
			 <?php
				...
				$dpt1=implode("','",$dpt);				
				$item_row=mssql_query("select * from employee_master where department in ('$dpt1') order by employee_id desc");		
				$s1=1;
			 ?>
		...
		<?php  
		$item1=mssql_fetch_array(mssql_query("select top 1 * from employee_master where department in ('$dpt1') $rs ORDER BY id DESC"));
		if($id=="")
		{
			$id=$item1['id'];
		}
...
$view=$emp['view_only'];
				...
				<table class="table table-hover table-bordered" style="font-family:'Times New Roman', Times, serif">
					<tbody>
						<tr>
							<td>Employee ID</td>
							<td><input type="text" name="emp_id" id="emp_id" class="form-control" value="<?php echo $eid=$item1['employee_id']; ?>" readonly ></td>
							<td>Employee Name</td>
