...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[15,30,45,60],loading:false,buttons:null,showPageList:true,showPageInfo:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh","info"],onSelectPage:function(_d2,_d3){
...
_234.empty();
var _235=$("<div class=\"panel-title\"></div>").html("Summary Report").appendTo(_234);
if(opts.iconCls){
...
opts.oldValue="";
var file=$("<input type=\"file\" autocomplete=\"off\" class=\"textbox-value\">").appendTo(_570.filebox);
...
try{
for(var n in _595){
var _597=$("<input type=\"hidden\" autocomplete=\"off\" name=\""+n+"\">").val(_595[n]).appendTo(form);
_596=_596.add(_597);
}
_598();
form[0].submit();
...
dc.body1.add(dc.body2).prepend("<table id=\"datagrid-table\" class=\"datagrid-btable datagrid-btable-frozen\" cellspacing=\"0\" cellpadding=\"0\"></table>");
}
_687(true);
_687(false);
_665(_684);
...
var _7dc=$("<input type=\"text\" autocomplete=\"off\" class=\"datagrid-editable-input\">").appendTo(_7da);
...
var _7f5=$("<input type=\"text\" autocomplete=\"off\" class=\"datagrid-editable-input\">").appendTo(_7f3);
...
var _83a=["<table id=\"datagrid-table\" class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
...
var _a47=$("<input type=\"hidden\" autocomplete=\"off\" class=\"textbox-value\">").appendTo(_a43);
_a47.attr("name",name);
if(opts.disabled){
...
(function($){
function init(_be3){
var _be4=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" autocomplete=\"off\" class=\"slider-value\">"+"</div>").insertAfter(_be3);
var t=$(_be3);
...
var _c06=$("<input type=\"hidden\" autocomplete=\"off\" class=\"slider-value\">").appendTo(_c02);
_c06.attr("name",name);
_c06.val(_c05);
_c04.push(_c05);
